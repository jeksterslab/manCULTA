...
Checks whether the model fitting procedure for an object of class
`fitculta` has successfully converged.
...
Logical. `TRUE` if the model has converged, `FALSE` otherwise.

# Generate Mplus Inout file for the One-Profile CULTA Model (CUTS Model with AR)

Generates `Mplus` input file for the one-profile CULTA model.

## Usage

``` r
InputCULTA1Profile(data, wd = ".", starts = 10, starting_values = NULL)
```
